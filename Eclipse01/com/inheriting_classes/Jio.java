...
public class Jio extends PhoneOperator {
	private String planName;

	public Jio(String operator, String phoneNo) {
	...
	public double planPrice(String planName) {
		...
		if (planName.equals("300-1gb/day-84-days")) {
	...
	public static void main(String[] args) {
		...
		new Jio("Jio", "3456789088").call("6675430789");
	}
